 ...
 * <ul>
 *   <li>{@link RDBMS.impl.FKeyImpl#getReferences <em>References</em>}</li>
 *   <li>{@link RDBMS.impl.FKeyImpl#getCols <em>Cols</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FKeyImpl extends MinimalEObjectImpl.Container implements FKey {
	...
	protected EClass eStaticClass() {
		return RDBMSPackage.Literals.FKEY;
	}
		...
		if (references != null && references.eIsProxy()) {
			...
			if (references != oldReferences) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, RDBMSPackage.FKEY__REFERENCES, oldReferences, references));
			}
		}
		return references;
	}
	...
	public void setReferences(Table newReferences) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RDBMSPackage.FKEY__REFERENCES, oldReferences, references));
	}
	...
	public EList<Column> getCols() {
		if (cols == null) {
			cols = new EObjectResolvingEList<Column>(Column.class, this, RDBMSPackage.FKEY__COLS);
		}
		return cols;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case RDBMSPackage.FKEY__REFERENCES:
				if (resolve) return getReferences();
				return basicGetReferences();
			case RDBMSPackage.FKEY__COLS:
				return getCols();
		}
