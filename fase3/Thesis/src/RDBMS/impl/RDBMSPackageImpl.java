...
public class RDBMSPackageImpl extends EPackageImpl implements RDBMSPackage {
	...
	public static RDBMSPackage init() {
		...
		PTPackageImpl thePTPackage = (PTPackageImpl)(EPackage.Registry.INSTANCE.getEPackage(PTPackage.eNS_URI) instanceof PTPackageImpl ? EPackage.Registry.INSTANCE.getEPackage(PTPackage.eNS_URI) : PTPackage.eINSTANCE);
	 ...
	 * @generated
	 */
	public EAttribute getTable_Tipo() {
	...
	public void createPackageContents() {
		...
		createEReference(tableEClass, TABLE__FKEYS);
		createEReference(tableEClass, TABLE__PKEY);
		createEReference(tableEClass, TABLE__COLS);
		createEAttribute(tableEClass, TABLE__TIPO);
		...
		createEReference(fKeyEClass, FKEY__COLS);
	...
	public void initializePackageContents() {
		...
		PTPackage thePTPackage = (PTPackage)EPackage.Registry.INSTANCE.getEPackage(PTPackage.eNS_URI);
		...
		initEAttribute(getTable_Name(), thePTPackage.getString(), "name", null, 1, 1, Table.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getTable_Fkeys(), this.getFKey(), null, "fkeys", null, 0, -1, Table.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getTable_Pkey(), this.getColumn(), null, "pkey", null, 0, -1, Table.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getTable_Tipo(), thePTPackage.getString(), "tipo", null, 0, 1, Table.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(columnEClass, Column.class, "Column", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getColumn_Name(), thePTPackage.getString(), "name", null, 1, 1, Column.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getColumn_Type(), thePTPackage.getString(), "type", null, 1, 1, Column.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEClass(fKeyEClass, FKey.class, "FKey", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getFKey_References(), this.getTable(), null, "references", null, 1, 1, FKey.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getFKey_Cols(), this.getColumn(), null, "cols", null, 0, -1, FKey.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEClass(schemaEClass, Schema.class, "Schema", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getSchema_Name(), thePTPackage.getString(), "name", null, 0, 1, Schema.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
