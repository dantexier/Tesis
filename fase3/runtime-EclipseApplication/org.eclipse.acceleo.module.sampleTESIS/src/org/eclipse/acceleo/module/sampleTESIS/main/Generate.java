 ...
 *******************************************************************************/
package org.eclipse.acceleo.module.sampleTESIS.main;
...
public class Generate extends AbstractAcceleoGenerator {
     ...
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/org/eclipse/acceleo/module/sampleTESIS/main/generate";
    ...
    public void registerPackages(ResourceSet resourceSet) {
        ...
        if (!isInWorkspace(RDBMS.RDBMSPackage.class)) {
            resourceSet.getPackageRegistry().put(RDBMS.RDBMSPackage.eINSTANCE.getNsURI(), RDBMS.RDBMSPackage.eINSTANCE);
        }
