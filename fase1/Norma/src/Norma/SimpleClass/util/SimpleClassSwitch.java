/**
 */
package Norma.SimpleClass.util;
 ...
 * <!-- end-user-doc -->
 * @see Norma.SimpleClass.SimpleClassPackage
 * @generated
 */
public class SimpleClassSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case SimpleClassPackage.CLASS: {
				Norma.SimpleClass.Class class_ = (Norma.SimpleClass.Class)theEObject;
			...
			case SimpleClassPackage.SCHEMA: {
	 ...
	 * @generated
	 */
	public T caseClass(Norma.SimpleClass.Class object) {
		return null;
	}
