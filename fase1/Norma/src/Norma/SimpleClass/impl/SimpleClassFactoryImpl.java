...
public class SimpleClassFactoryImpl extends EFactoryImpl implements SimpleClassFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case SimpleClassPackage.SCHEMA: return createSchema();
			default:
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			case SimpleClassPackage.EA:
				return createEAFromString(eDataType, initialValue);
			case SimpleClassPackage.VOCABULARY:
				return createVocabularyFromString(eDataType, initialValue);
			default:
	...
	public String convertToString(EDataType eDataType, Object instanceValue) {
		switch (eDataType.getClassifierID()) {
			case SimpleClassPackage.EA:
				return convertEAToString(eDataType, instanceValue);
			case SimpleClassPackage.VOCABULARY:
				return convertVocabularyToString(eDataType, instanceValue);
			default:
				throw new IllegalArgumentException("The datatype '" + eDataType.getName() + "' is not a valid classifier");
		}
	}
	 ...
	 * @generated
	 */
	public Norma.SimpleClass.Class createClass() {
	 ...
	 * @generated
	 */
	public EA createEAFromString(EDataType eDataType, String initialValue) {
		EA result = EA.get(initialValue);
	 ...
	 * @generated
	 */
	public String convertEAToString(EDataType eDataType, Object instanceValue) {
	 ...
	 * @generated
	 */
	public Vocabulary createVocabularyFromString(EDataType eDataType, String initialValue) {
		Vocabulary result = Vocabulary.get(initialValue);
		if (result == null) throw new IllegalArgumentException("The value '" + initialValue + "' is not a valid enumerator of '" + eDataType.getName() + "'");
		return result;
	}
	 ...
	 * @generated
	 */
	public String convertVocabularyToString(EDataType eDataType, Object instanceValue) {
		return instanceValue == null ? null : instanceValue.toString();
	}
