 ...
 * @generated
 */
public class SimpleClassDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public SimpleClassDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof Norma.SimpleClass.diagram.navigator.SimpleClassDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((Norma.SimpleClass.diagram.navigator.SimpleClassDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new Norma.SimpleClass.diagram.navigator.SimpleClassDomainNavigatorItem(
