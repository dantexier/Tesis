 ...
 * @generated
 */
public class SimpleClassViewProvider extends AbstractProvider implements
		IViewProvider {
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = Norma.SimpleClass.diagram.part.SimpleClassVisualIDRegistry
					.getNodeVisualID(op.getContainerView(), domainElement);
		} else {
			visualID = Norma.SimpleClass.diagram.part.SimpleClassVisualIDRegistry
					.getVisualID(op.getSemanticHint());
			if (elementType != null) {
				if (!Norma.SimpleClass.diagram.providers.SimpleClassElementTypes
		...
		return Norma.SimpleClass.diagram.edit.parts.ClassEditPart.VISUAL_ID == visualID;
	}
	...
	public Diagram createDiagram(IAdaptable semanticAdapter,
		...
		diagram.setType(Norma.SimpleClass.diagram.edit.parts.SchemaEditPart.MODEL_ID);
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		case Norma.SimpleClass.diagram.edit.parts.AssociationSrcEditPart.VISUAL_ID:
			return createAssociationSrc_4001(containerView, index, persisted,
					preferencesHint);
		case Norma.SimpleClass.diagram.edit.parts.AssociationDestEditPart.VISUAL_ID:
			return createAssociationDest_4002(containerView, index, persisted,
					preferencesHint);
		}
	...
	public Node createClass_2001(EObject domainElement, View containerView,
		...
		node.setType(Norma.SimpleClass.diagram.part.SimpleClassVisualIDRegistry
	 ...
	 * @generated
	 */
	public Edge createAssociationSrc_4001(View containerView, int index,
		...
		edge.setType(Norma.SimpleClass.diagram.part.SimpleClassVisualIDRegistry
	 ...
	 * @generated
	 */
	public Edge createAssociationDest_4002(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
	...
	private void stampShortcut(View containerView, Node target) {
		if (!Norma.SimpleClass.diagram.edit.parts.SchemaEditPart.MODEL_ID
			...
			shortcutAnnotation
					.getDetails()
					.put("modelID", Norma.SimpleClass.diagram.edit.parts.SchemaEditPart.MODEL_ID); //$NON-NLS-1$
