 ...
 * @generated
 */
public class AssociationDestReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public AssociationDestReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return Norma.SimpleClass.diagram.edit.policies.SimpleClassBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistAssociationDest_4002(
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().setDest(null);
		getNewSource().setDest(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().setDest(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
