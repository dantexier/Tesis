...
/**
 * This is the item provider adapter for a {@link Norma.SimpleClass.Schema} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SchemaItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SimpleClassPackage.Literals.SCHEMA__CLASES);
			childrenFeatures.add(SimpleClassPackage.Literals.SCHEMA__RELACIONES);
			childrenFeatures.add(SimpleClassPackage.Literals.SCHEMA__DATOS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SimpleClassPackage.Literals.SCHEMA__CLASES,
				 SimpleClassFactory.eINSTANCE.createClass()));

		newChildDescriptors.add
			(createChildParameter
				(SimpleClassPackage.Literals.SCHEMA__RELACIONES,
				 SimpleClassFactory.eINSTANCE.createAssociation()));

		newChildDescriptors.add
			(createChildParameter
				(SimpleClassPackage.Literals.SCHEMA__DATOS,
