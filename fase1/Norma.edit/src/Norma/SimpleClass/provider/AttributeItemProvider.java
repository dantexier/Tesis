...
/**
 * This is the item provider adapter for a {@link Norma.SimpleClass.Attribute} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AttributeItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addIs_primaryPropertyDescriptor(object);
	 ...
	 * @generated
	 */
	protected void addIs_primaryPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Attribute_is_primary_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Attribute_is_primary_feature", "_UI_Attribute_type"),
				 SimpleClassPackage.Literals.ATTRIBUTE__IS_PRIMARY,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
