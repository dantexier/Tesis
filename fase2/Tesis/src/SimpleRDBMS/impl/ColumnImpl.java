 ...
 * <ul>
 *   <li>{@link SimpleRDBMS.impl.ColumnImpl#getName <em>Name</em>}</li>
 *   <li>{@link SimpleRDBMS.impl.ColumnImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ColumnImpl extends MinimalEObjectImpl.Container implements Column {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SimpleRDBMSPackage.COLUMN__NAME, oldName, name));
	}
