 ...
 * <ul>
 *   <li>{@link SimpleRDBMS.impl.FKeyImpl#getReferences <em>References</em>}</li>
 *   <li>{@link SimpleRDBMS.impl.FKeyImpl#getCols <em>Cols</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FKeyImpl extends MinimalEObjectImpl.Container implements FKey {
	...
	protected EClass eStaticClass() {
		return SimpleRDBMSPackage.Literals.FKEY;
	}
		...
		if (references != null && references.eIsProxy()) {
			...
			if (references != oldReferences) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SimpleRDBMSPackage.FKEY__REFERENCES, oldReferences, references));
			}
		}
		return references;
	}
	...
	public void setReferences(Table newReferences) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SimpleRDBMSPackage.FKEY__REFERENCES, oldReferences, references));
	}
	...
	public EList<Column> getCols() {
		if (cols == null) {
			cols = new EObjectResolvingEList<Column>(Column.class, this, SimpleRDBMSPackage.FKEY__COLS);
		}
		return cols;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SimpleRDBMSPackage.FKEY__REFERENCES:
				if (resolve) return getReferences();
				return basicGetReferences();
			case SimpleRDBMSPackage.FKEY__COLS:
				return getCols();
		}
